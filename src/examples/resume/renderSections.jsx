...
export const RenderSection = ({ section }) => {
  ...
  switch (section.sectionType) {
    ...
    case "educations":
      return (
        <Section title={i18n.t("education")} iconBuffer={imgData}>
          {section.items.map((item) => (
            <Сard
              key={item.id}
              title={multiJoin(
    ...
    case "workExperiences":
      return (
        <Section title={i18n.t("work_experience")} iconBuffer={imgData}>
          {section.items.map((item) => (
            <Сard
              key={item.id}
              title={multiJoin(
    ...
    case "references":
      return (
        <Section title={i18n.t("references")} iconBuffer={imgData}>
    ...
    case "internships":
      return (
        <Section title={i18n.t("internships")} iconBuffer={imgData}>
          {section.items.map((item) => (
            <Сard
              key={item.id}
              title={multiJoin(
    ...
    case "profile":
      return (
        <Section title={i18n.t("profile")} iconBuffer={imgData}>
          RICHTEXTRICHTEXT
        </Section>
      );
    case "custom":
      return (
        <Section title={section.title} iconBuffer={imgData}>
          {section.items.map((item) => (
            <Сard
              key={item.id}
